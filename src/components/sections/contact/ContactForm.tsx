    ...
    <section className="relative flex w-full flex-col items-center bg-white pb-0 pt-20">
      <div className="mx-auto w-full max-w-[1200px] px-6">
        ...
        <div className="flex flex-col overflow-hidden rounded-3xl md:flex-row">
          ...
          <div className="flex w-full flex-col justify-center bg-[#F7F7F7] p-10 md:w-1/2 md:p-16 lg:p-20">
            ...
            <ul className="flex flex-col gap-6 font-dmSerifText text-sm font-normal text-loren-black md:text-base">
              <li className="flex items-center gap-4">
                <Mail className="h-5 w-5 text-[#FF3333]" strokeWidth={2.5} />
              ...
              <li className="flex items-center gap-4">
                <Clock className="h-5 w-5 text-[#FF3333]" strokeWidth={2.5} />
          ...
          <div className="flex w-full flex-col justify-center bg-[#FCEAEA] p-10 md:w-1/2 md:p-16 lg:p-20">
            ...
            <form className="flex flex-col gap-5">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Name"
                  className="w-full rounded-md border border-zinc-200 bg-white px-4 py-3 text-sm outline-none transition-colors focus:border-[#FF3333]"
                  required
                />
                <span className="absolute right-4 top-3 text-[#FF3333]">*</span>
              </div>
              <div className="relative">
                <input
                  type="email"
              ...
              <div className="relative">
                <textarea
                  placeholder="Message"
                  rows={5}
                  className="w-full resize-none rounded-md border border-zinc-200 bg-white px-4 py-3 text-sm outline-none transition-colors focus:border-[#FF3333]"
                  required
                />
              </div>
